...
const Contact = () => {
    ...
    return (
        <section id="contact">
          <div className="h-36 md:h-52 lg:h-96 bg-[url('../public/images/decoration/wave.svg')] bg-cover"></div>
          <div className="hero bg-flash">
            <div className="hero-content text-center">
              <div className="card w-[80%] max-w-xl md:max-w-2xl lg:max-w-2xl shadow-2xl text-main p-4">
                <h1 className="mb-5 text-3xl md:text-4xl font-bold">{t('contactme')}</h1>
