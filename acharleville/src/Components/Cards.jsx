    ...
    return (
        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-none lg:grid-cols-3 place-content-center place-items-center gap-4">
                <Card w="48" id="14" title="LOOT - Court-Métrage " role="Sync&Sound Design" date="Mars 2023" desc="Ce projet représente un défi passionnant, car il requiert une synchronisation précise des voix avec les mêmes doubleurs pour chaque personnage. Le montage s'est révélé particulièrement minutieux, notamment pour ajuster les labiales de l'anglais au français. Recréer entièrement une atmosphère à partir des images a été un véritable jeu, tout en maintenant une tension croissante tout au long de la progression narrative." pic="./images/projects/loot.png" alt="LOOT PROJECT" ylink="https://www.youtube.com/embed/2cPZWcSqdCw" ytitle="LOOT - Sync&Sound Design • Charleville"/>
                
                <Card w="48" id="13" title="Spiderman - New generation" role="Sound Design" date="Mai 2023" desc="J'ai entrepris ce projet de sound design en m'inspirant d'un travail que j'admire particulièrement. Mon objectif était de réaliser rapidement le sound design, l'enregistrement des voix et le mixage. Pour ce faire, j'ai alloué trois jours à l'enregistrement, suivi d'une semaine dédiée au montage audio et musical, puis d'une autre semaine consacrée au mixage." pic="./images/projects/spiderman.png" alt="SPIDERMAN PROJECT" ylink="https://www.youtube.com/embed/fwA4coxcQ0M" ytitle="Spiderman - New generation • Charleville"/>
                ...
                <Card w="48" id="99" title="DOLBY - Publicité" role="Sync&Sound Design" desc="Ce sound design est axé sur l'exploration sensorielle et l'immersion spatiale. En jouant avec les canaux gauche et droit, je crée une expérience où les fréquences hautes et basses enveloppent l'auditeur, l'invitant à ressentir physiquement les éléments du son autour de lui. Mon objectif est de susciter des émotions profondes et une immersion totale dans un monde sonore parallèle, où chaque détail est soigneusement conçu pour captiver et transporter l'auditeur." date="Decembre 2022" pic="./images/projects/dolbypub.png" alt="DolbyPubProject" ylink="https://www.youtube.com/embed/watch?v=-vrJUgGpaRU" ytitle="DOLBY - Sound design • Charleville"/>
