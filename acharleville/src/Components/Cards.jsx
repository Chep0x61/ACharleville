    ...
    return (
        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-none lg:grid-cols-3 place-content-center place-items-center gap-4">
                <Card w="48" id="12" title="Arcane - Trailer" date="Sound Design" desc="Workshop scolaire intéressant par sa diversité de SFX à réaliser. Les principaux défis étaient de créer un univers aussi complexe, réussir à monter l'émotion à mesure que l'histoire défile en si peu de temps. La majeure partie des bruitages ont été fait en studio, ainsi que le doublage. La mise aux normes a été ensuite appliquée." pic="./images/arcane1.jpg" alt="Projet1" ylink="https://www.youtube.com/embed/0C8mb2HJfl0" ytitle="ARCANE - Sound design • Charleville"/>

                <Card w="48" id="11" title="Court Métrage - Le caméléon" date="Ingénieur Son" desc="Court-métrage soutenu par l'équipe pédagogique de l'école Cinécréatis. La prise de son a été prise en direct sur le lieu de tournage. J'occupais le poste de responsable de la post-production sonore. Cela a été un de mes premiers projets aussi volumineux, et j'en garde une bonne expérience." pic="./images/cameleon.jpg" alt="Projet2" ylink="https://www.youtube.com/embed/OA2onnhzWxc" ytitle="LE CAMELEON - Ingénieur son • Charleville"/>

                <Card w="48" id="10" title="Habitat Inédit - Fournier Roux" date="Bruitages" desc="Un workshop où sound design et bruitage fusionnent. L'objectif était de coller parfaitement à l'image. Tromper le spectateur avec inventivité est un jeu créatif et manuel, dont on s'inspire des plus grands d'Hollywood." pic="./images/bird.jpg" alt="Projet2" ylink="https://www.youtube.com/embed/aWsqpFQNX5M" ytitle="HABITAT INEDIT - Sound Design • Charleville"/>

                <Card w="48" id="9" title="Court Métrage - Memphré" date="Doublage" desc="En collaboration avec des élèves de l'école LISAA, pour créer ce court-métrage dont l'amitié et l'aventure font son charme. Il a fallu aller démarcher des comédiennes, puis travailler ensemble dans une démarche artistique pour y trouver la même harmonie pour coller à nos deux personnages, Alma et Sylvie." pic="./images/lisa.jpg" alt="Projet2" ylink="https://www.youtube.com/embed/KrrrTvE6ccE" ytitle="Memphré | Film de diplôme Bachelor Animation 2D | 2022"/>

                <Card w="48" id="8" title="Un millimètre Audi" date="Sound Design" desc="Du sound design pur et futuriste, en collaboration avec Manon Chapelière, soutenu par l'équipe pédagogique de l'école. Le fait d'être plusieurs sur le sound design oblige à trouver un terrain d'entente, et nous avons choisi un son des plus texturé et authentique possible. La musique a été créée pour la publicité également." pic="./images/audi.png" alt="Projet2" ylink="https://www.youtube.com/embed/Mv2Ni31HSMw" ytitle=" AUDI - 1 millimètre - Sound Design • Chapelière&Charleville"/>
                ...
                <Card w="48" id="4" title="Oktapodi" date="Sound Design" desc="Un de mes premiers gros projets de sound design, son principal défi était les bruitages d'eau. De l'enregistrement grandeur nature, à la post production, qui demandait beaucoup de resynchronisation. Merci au soutien de l'équipe pédagogique et à l'investissement de la classe." pic="./images/okto.jpg" alt="Projet2" ylink="https://www.youtube.com/embed/R6sF4R_4lfo" ytitle="OKTAPODI - Sound Design • Charleville"/>

                <Card w="48" id="3" title="Court Métrage - Espérance" date="Ingénieur Son" desc="Court-métrage pour le Nikon festival, j'ai été à la prise de son en extérieur sur plateau de tournage, aidé d'une perchwoman. Puis à la post-production sonore, mixage et sound design compris." pic="./images/esperance.jpg" alt="Projet2" ylink="https://www.youtube.com/embed/UTM-zQc1Kdk" ytitle="ESPERANCE - Court métrage • Charleville"/>

                <Card w="48" id="2" title="Habitat Inédit Castor" date="Bruitages" desc="Workshop soutenu par l'équipe pédagogique de l'école. En partant de zéro, il a nécessité des enregistrements de foley, du sound design et doublage français en studio. Puis une première approche de la création musicale ainsi que son mixage par la suite." pic="./images/castor.jpg" alt="Projet2" ylink="https://www.youtube.com/embed/n3ESj7TLkn4" ytitle="HABITAT INÉDIT - ARTE - Sound Design • Charleville"/>

                <Card w="48" id="1" title="Publicité Fubiz" date="Sound Design" desc="Publicité Fubiz" pic="./images/fubiz.gif" alt="Projet2" ylink="https://www.youtube.com/embed/slnDy3KtH9Y" ytitle=" FUBIZ - Sound Design • Charleville "/>
