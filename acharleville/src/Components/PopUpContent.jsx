        ...
        <div>
          ...
          <div className="modal">
            <div ref={popupRef} className="modal-box w-[90%] max-w-4xl bg-retry">
              ...
              <iframe ref={iframeRef} id="video" width={iframeWidth} height={iframeHeight} src={ylink} title={ytitle} frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
              </div>
